...
async function getLast10Matches(url) {
    ...
    var original = require('D:/Proyectos/olympus/zeus-api/db/2023/matches/matchesLigue12023Flashcore.json');
    ...
    FS.truncate('D:/Proyectos/olympus/zeus-api/db/2023/matches/matchesLigue12023Flashcore.json', 0, function (err) {
        if (err) {
    ...
    FS.writeFile('D:/Proyectos/olympus/zeus-api/db/2023/matches/matchesLigue12023Flashcore.json', JSON.stringify(original), function (err) {
        if (err) {
